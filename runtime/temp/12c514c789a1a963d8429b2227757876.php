<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/news/show.html";i:1476721165;s:82:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/layout.html";i:1476191596;s:87:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/public/menu.html";i:1476028069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="main-container" id="main-container">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <th class="center">新闻作者</th>
            <th class="center">上传时间</th>
            <th class="center">操作</th>
        </tr>
        </thead>
        <tbody class="center">
        <?php if(is_array($newsList) || $newsList instanceof \think\Collection): $i = 0; $__LIST__ = $newsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo $news['newsTitle']; ?></td>
                <td><?php echo $news['author']; ?></td>
                <td><?php echo $news['createTime']; ?></td>
                <td>删除</td>
            </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
