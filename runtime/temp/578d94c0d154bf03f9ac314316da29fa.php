<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/news/add.html";i:1476377630;s:82:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/layout.html";i:1476191596;s:87:"/Users/zhouweiyong/Code/web/Think5Api/public/../application/admin/view/public/menu.html";i:1476028069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $Config['current_control']; ?></li>
                </ul><!-- .breadcrumb -->

            </div>
            <div class="page-header">
                <h1>
                    <?php echo $Config['current_control']; ?>
                    <small>
                        <i class="icon-double-angle-right"></i>
                        <?php echo $Config['current_action']; ?>
                    </small>
                </h1>
            </div>

            <div class="page-content"><div>
    <form action="<?php echo url('News/addNews'); ?>" method="post" class="form-horizontal">
        <div class="form-group h-30">
            <label for="newsTitle" class="col-xs-2 control-label">新闻标题</label>
            <div class="col-xs-10">
        ...
        <div class="form-group ">
            <label for="newsContent" class="col-xs-2 control-label">内容</label>
            <div class="col-xs-10">
                <textarea rows="10" id="newsContent" name="newsContent" class="form-control"></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-offset-2 center">
